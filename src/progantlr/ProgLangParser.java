...
public class ProgLangParser extends Parser {
	...
	public static final int
		...
		RULE_expr_and = 5, RULE_expr_eq = 6, RULE_expr_ineq = 7, RULE_expr_muldiv = 8, 
		RULE_expr_addsub = 9, RULE_expr_exp = 10, RULE_expr_base = 11;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "decl", "assign", "ifblock", "expr", "expr_and", "expr_eq", "expr_ineq", 
			"expr_muldiv", "expr_addsub", "expr_exp", "expr_base"
		};
	}
	...
	private Expr_muldivContext expr_muldiv(int _p) throws RecognitionException {
		...
		int _startState = 16;
		enterRecursionRule(_localctx, 16, RULE_expr_muldiv, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class PLExoFallthroughContext extends Expr_expContext {
		public Expr_baseContext expr_base() {
			return getRuleContext(Expr_baseContext.class,0);
		}
		public PLExoFallthroughContext(Expr_expContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ProgLangListener ) ((ProgLangListener)listener).enterPLExoFallthrough(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ProgLangListener ) ((ProgLangListener)listener).exitPLExoFallthrough(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProgLangVisitor ) return ((ProgLangVisitor<? extends T>)visitor).visitPLExoFallthrough(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private Expr_expContext expr_exp(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			_localctx = new PLExoFallthroughContext(_localctx);
			_ctx = _localctx;
			_prevctx = _localctx;
